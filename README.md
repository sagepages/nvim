...
```sh
git clone https://github.com/sagepages/.dotfiles.git ~/.config/nvim
```
...
Next you will need to add the server to this list: [servers](https://github.com/sagepages/.dotfiles/blob/8b9ec3bffe8c8577042baf07c75408532a733fea/lua/user/lsp/lsp-installer.lua#L6)
